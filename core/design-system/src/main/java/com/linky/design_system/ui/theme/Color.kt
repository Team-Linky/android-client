...
val ColorFamilyGray800AndGray100
    @Composable get() = ColorFamily(Gray800, Gray100).color
...
val ColorFamilyGray100AndGray600
    @Composable get() = ColorFamily(Gray100, Gray600).color
